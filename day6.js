...
while (quer != "não"){
    ...
    while(quer!= "sim" && quer!="não") {
        ...
        quer = prompt ("Você deseja adicionar um item a sua lista de compras ou remover ? Responda com 'sim', 'não' ou 'remover'");
    }
    if (quer === "não") {
        break;
    }
    else if (quer === "remover") {
